...
/**
 * CallListComparison Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallListComparison implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallListComparison';
    ...
    const FIELD_SALES_MANAGER_CODE = 'SalesManagerCode';
    const FIELD_LIST_ID = 'ListId';
    const FIELD_LIST_DATE = 'ListDate';
    const FIELD_IS_REMAINING_CALL = 'IsRemainingCall';
    const FIELD_IS_CALLBACK = 'IsCallback';
    ...
    public function getFieldAllowableValues()
    {
        return [
            ...
            self::FIELD_SALES_MANAGER_CODE,
            self::FIELD_LIST_ID,
            self::FIELD_LIST_DATE,
            self::FIELD_IS_REMAINING_CALL,
            self::FIELD_IS_CALLBACK,
        ];
    }
