...
/**
 * ControlGroupUnreleaseRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ControlGroupUnreleaseRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ControlGroupUnreleaseRequest';
     ...
     * Sets user_code
     *
     * @param string $user_code The ARP user ID to recreate the ARP control group;  WWWEB is used by default
     *
     * @return $this
     */
