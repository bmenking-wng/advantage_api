...
/**
 * RecurringDonationUpdateRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RecurringDonationUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RecurringDonationUpdateRequest';
     ...
     * Sets expires
     *
     * @param \DateTime $expires The expire date for the recurring donation.
     *
     * @return $this
     */
     ...
     * Sets payment
     *
     * @param \Advantage\Client\Model\RecurringDonationPaymentRequest $payment Info pertaining to payment for recurring donation. Only populate if you want to change   the payment method associated with the recurring donation.
     *
     * @return $this
     */
