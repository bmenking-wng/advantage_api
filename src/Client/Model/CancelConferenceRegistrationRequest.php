...
/**
 * CancelConferenceRegistrationRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CancelConferenceRegistrationRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CancelConferenceRegistrationRequest';
     ...
     * Sets cancel_reason
     *
     * @param string $cancel_reason The reason for the cancellation (e.g. Cancelled from web)
     *
     * @return $this
     */
