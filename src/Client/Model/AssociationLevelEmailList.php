...
/**
 * AssociationLevelEmailList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AssociationLevelEmailList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AssociationLevelEmailList';
     ...
     * Sets list_code
     *
     * @param string $list_code The list code identifying the email list the association level is linked to
     *
     * @return $this
     */
