...
/**
 * CallStatisticsFilter Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallStatisticsFilter implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallStatisticsFilter';
     ...
     * Sets begin_date
     *
     * @param \DateTime $begin_date The earliest call date to include in statistics.
     *
     * @return $this
     */
     ...
     * Sets end_date
     *
     * @param \DateTime $end_date The latest call date to include in statistics.
     *
     * @return $this
     */
     ...
     * Sets list_code
     *
     * @param string $list_code List code of the list to limit the statistics to or null or empty string to compile  statistics across lists.
     *
     * @return $this
     */
