...
/**
 * ConferenceRegistrationComparison Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConferenceRegistrationComparison implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConferenceRegistrationComparison';
    ...
    const FIELD_ATTENDEE_CUSTOMER_NUMBER = 'AttendeeCustomerNumber';
    const FIELD_BILL_TO_CUSTOMER_NUMBER = 'BillToCustomerNumber';
    const FIELD_CONFERENCE_ID = 'ConferenceId';
    ...
    {
        return [
            self::FIELD_ATTENDEE_CUSTOMER_NUMBER,
            self::FIELD_BILL_TO_CUSTOMER_NUMBER,
            self::FIELD_CONFERENCE_ID,
