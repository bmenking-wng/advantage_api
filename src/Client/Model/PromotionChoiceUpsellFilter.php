...
/**
 * PromotionChoiceUpsellFilter Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PromotionChoiceUpsellFilter implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PromotionChoiceUpsellFilter';
     ...
     * Sets order_number
     *
     * @param string $order_number Do not upsell items already included on the given order.  (Optional.  No used when listing promotions by order.)
     *
     * @return $this
     */
     ...
     *
     * @param string $customer_number The customer who will see the upsell.  (Optional.  Not used when listing promotions by customer.)
     *
     * @return $this
     */
