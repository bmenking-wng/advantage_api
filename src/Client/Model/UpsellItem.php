 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpsellItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpsellItem';
     ...
     * Sets item_number
     *
     * @param string $item_number The product to upsell.
     *
     * @return $this
     */
     ...
     *
     * @param string $promotion_choice Promotion choice to use if item is ordered.
     *
     * @return $this
     */
