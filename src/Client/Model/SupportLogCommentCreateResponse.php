...
/**
 * SupportLogCommentCreateResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SupportLogCommentCreateResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SupportLogCommentCreateResponse';
     ...
     * Sets comment_id
     *
     * @param string $comment_id The comment id is a unique number that identifies a client support log comment
     *
     * @return $this
     */
