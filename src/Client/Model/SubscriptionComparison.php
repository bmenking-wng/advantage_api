...
/**
 * SubscriptionComparison Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SubscriptionComparison implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubscriptionComparison';
    ...
    const FIELD_PUBLICATION_CODE = 'PublicationCode';
    const FIELD_SHIP_TO_CUSTOMER_NUMBER = 'ShipToCustomerNumber';
    const FIELD_SUBSCRIPTION_ID = 'SubscriptionId';
    const FIELD_BILL_TO_CUSTOMER_NUMBER = 'BillToCustomerNumber';
    const FIELD_REFERRED_BY_CUSTOMER_NUMBER = 'ReferredByCustomerNumber';
    const FIELD_OWNING_ORGANIZATION_CODE = 'OwningOrganizationCode';
    const FIELD_CIRCULATION_STATUS = 'CirculationStatus';
    ...
    {
        return [
            self::FIELD_PUBLICATION_CODE,
            self::FIELD_SHIP_TO_CUSTOMER_NUMBER,
            self::FIELD_SUBSCRIPTION_ID,
            self::FIELD_BILL_TO_CUSTOMER_NUMBER,
            self::FIELD_REFERRED_BY_CUSTOMER_NUMBER,
            self::FIELD_OWNING_ORGANIZATION_CODE,
            self::FIELD_CIRCULATION_STATUS,
        ];
    }
