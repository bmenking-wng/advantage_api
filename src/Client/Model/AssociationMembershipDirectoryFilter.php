...
/**
 * AssociationMembershipDirectoryFilter Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AssociationMembershipDirectoryFilter implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AssociationMembershipDirectoryFilter';
     ...
     * Sets search
     *
     * @param string $search The generic search argument. (Typically from a search text box).  This term will be compared to the member's name.
     *
     * @return $this
     */
     ...
     *
     * @param string $structure_node_id The ID of a structure node.  Only members from this node or a descendant of this node will be returned.
     *
     * @return $this
     */
