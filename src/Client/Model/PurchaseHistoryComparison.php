...
/**
 * PurchaseHistoryComparison Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PurchaseHistoryComparison implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PurchaseHistoryComparison';
    ...
    const FIELD_PRODUCT_FORMAT_CODE = 'ProductFormatCode';
    const FIELD_BILLING_ORGANIZATION_CODE = 'BillingOrganizationCode';
    const FIELD_ORDER_DATE = 'OrderDate';
    const FIELD_BILL_TO_CUSTOMER = 'BillToCustomer';
    const FIELD_SHIP_TO_CUSTOMER = 'ShipToCustomer';
    ...
    public function getFieldAllowableValues()
    {
        return [
            ...
            self::FIELD_PRODUCT_FORMAT_CODE,
            self::FIELD_BILLING_ORGANIZATION_CODE,
            self::FIELD_ORDER_DATE,
            self::FIELD_BILL_TO_CUSTOMER,
            self::FIELD_SHIP_TO_CUSTOMER,
        ];
    }
