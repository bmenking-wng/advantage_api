...
/**
 * AgreementComparison Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AgreementComparison implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AgreementComparison';
    ...
    const FIELD_ORDER_BY_CUSTOMER_NUMBER = 'OrderByCustomerNumber';
    const FIELD_PARTICIPANT_CUSTOMER_NUMBER = 'ParticipantCustomerNumber';
    const FIELD_ACCESS_SERVICE_CODE = 'AccessServiceCode';
    ...
    public function getFieldAllowableValues()
    {
        return [
            ...
            self::FIELD_ORDER_BY_CUSTOMER_NUMBER,
            self::FIELD_PARTICIPANT_CUSTOMER_NUMBER,
            self::FIELD_ACCESS_SERVICE_CODE,
