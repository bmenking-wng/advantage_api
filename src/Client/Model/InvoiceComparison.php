...
/**
 * InvoiceComparison Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InvoiceComparison implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InvoiceComparison';
    ...
    const FIELD_ORDER_TOTAL = 'OrderTotal';
    const FIELD_AMOUNT_PAID = 'AmountPaid';
    const FIELD_DEBIT_FULLY_PAID_FLAG = 'DebitFullyPaidFlag';
    ...
    public function getFieldAllowableValues()
    {
        return [
            ...
            self::FIELD_ORDER_TOTAL,
            self::FIELD_AMOUNT_PAID,
            self::FIELD_DEBIT_FULLY_PAID_FLAG,
            self::FIELD_DUE_DATE,
