...
/**
 * PublicationSummary Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PublicationSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PublicationSummary';
     ...
     * Sets code
     *
     * @param string $code The publication code
     *
     * @return $this
     */
     ...
     *
     * @param int $issues_per_year The typical number of issues per year for the publication
     *
     * @return $this
     */
